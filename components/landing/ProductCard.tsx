...
export default function ProductCard({ system }: { system: System }) {
  return (
    <div className="group flex flex-col bg-white rounded-2xl border border-slate-200 p-6 hover:border-[#1A56DB] hover:shadow-lg hover:shadow-blue-50 transition-all duration-300">
